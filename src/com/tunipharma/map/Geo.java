...
public class Geo {
     ...
     private ArrayList loc=new ArrayList();
     public ArrayList location(String address)throws IOException, XPathExpressionException, ParserConfigurationException, SAXException{
